...
public class Constants {
    ...
    // zk节点
    public static final String ROOT_PATH_EPHEMERAL = "/mcn/monitor/scroll";
    public static final String ROOT_PATH_PERSISTENT = "/mcn/monitor/query";
    public static final String APPENDER_INIT_DATA = "appender_init_data";

    public static final String EMPTY_STR = "";

    // mail
    public static final String MONITOR_APP_ALERT = "";
    ...
    public static final String EVENT_TYPE_SPIDER_LIST = "list";
    public static final String EVENT_TYPE_SPIDER_DETAIL = "detail";
    public static final String EVENT_TYPE_SPIDER_RISK = "risk";
    public static final String EVENT_TYPE_SPIDER_DETAIL_RISK = "drisk";
    public static final String EVENT_TYPE_SPIDER_PROXY = "proxy";
    public static final String EVENT_TYPE_SPIDER_DETAIL_PROXY = "dproxy";
    public static final String EVENT_TYPE_SPIDER_INIT = "init";
    public static final String EVENT_TYPE_SPIDER_ARRIAVE = "arrive";
    public static final String EVENT_TYPE_SPIDER_START = "invoke";
    // 统计 日志类型
    public static final String STASTIC_TYPE_TASK = "task";
    public static final String STASTIC_TYPE_IP = "ip";
    public static final String STASTIC_TYPE_TASKEX = "taskEx";
    ...
    // docker容器相关
    public static final String SKYEYE_HOST_TO_REGISTRY = "MCN_HOST_TO_REGISTRY";
